...
void CNode::copyStats(CNodeStats &stats, const std::vector<bool> &m_asmap)
{
    ...
    // Raw ping time is in microseconds, but show it to user as whole seconds (Noir users should be well used to small numbers with many decimal places by now :)
...
void CConnman::AcceptConnection(const ListenSocket& hListenSocket) {
    ...
    // NOIR don't accept incoming connections until fully synced
...
bool CConnman::Start(CScheduler& scheduler, const Options& connOptions)
{
    ...
    // NOIR Initiate masternode connections
